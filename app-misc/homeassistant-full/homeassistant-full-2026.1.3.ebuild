...
RDEPEND="${RDEPEND}
	...
	compit? ( ~dev-python/compit-inext-api-0.4.2[${PYTHON_USEDEP}] )
	...
	google_air_quality? ( ~dev-python/google_air_quality_api-3.0.0[${PYTHON_USEDEP}] )
	...
	hdfury? ( ~dev-python/hdfury-1.4.2[${PYTHON_USEDEP}] )
	...
	icloud? ( ~dev-python/pyicloud-2.3.0[${PYTHON_USEDEP}] )
	...
	imgw_pib? ( ~dev-python/imgw-pib-2.0.1[${PYTHON_USEDEP}] )
	...
	ntfy? ( ~dev-python/aiontfy-0.7.0[${PYTHON_USEDEP}] )
	...
	onedrive? ( ~dev-python/onedrive-personal-sdk-0.1.1[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.16.5[${PYTHON_USEDEP}] )
	...
	saunum? ( ~dev-python/pysaunum-0.3.0[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/uiprotect-10.0.1[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
	...
	waterfurnace? ( ~dev-python/waterfurnace-1.4.0[${PYTHON_USEDEP}] )
