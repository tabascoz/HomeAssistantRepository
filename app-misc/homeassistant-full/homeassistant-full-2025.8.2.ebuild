...
RDEPEND="${RDEPEND}
	...
	~dev-python/bleak-retry-connector-4.0.1[${PYTHON_USEDEP}]
	...
	~dev-python/home-assistant-frontend-20250811.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	aemet? ( ~dev-python/AEMET-OpenData-0.6.2[${PYTHON_USEDEP}] )
	...
	apple_tv? ( ~dev-python/pyatv-0.16.1[${PYTHON_USEDEP}] ~dev-python/tinytag-2.1.1[${PYTHON_USEDEP}]  )
	...
	bluetooth? ( ~dev-python/bleak-1.0.1[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.0.1[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.0.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.2[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.3[${PYTHON_USEDEP}] ~dev-python/habluetooth-5.0.2[${PYTHON_USEDEP}] ~dev-python/aiousbwatcher-1.1.1[${PYTHON_USEDEP}]   )
	...
	eq3btsmart? ( ~dev-python/eq3btsmart-1.1.9[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.1.0[${PYTHON_USEDEP}] )
	escea? ( ~dev-python/pescea-1.0.12[${PYTHON_USEDEP}] )
	esphome? ( ~dev-python/aioesphomeapi-39.0.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.1.0[${PYTHON_USEDEP}] )
	...
	google_cloud? ( ~dev-python/google-cloud-texttospeech-2.25.0[${PYTHON_USEDEP}] ~dev-python/google-cloud-speech-2.31.0[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/holidays-0.78[${PYTHON_USEDEP}] ~dev-python/Babel-2.15.0[${PYTHON_USEDEP}] )
	...
	home_connect? ( ~dev-python/homeconnect-0.8.0[${PYTHON_USEDEP}] ~dev-python/aiohomeconnect-0.18.1[${PYTHON_USEDEP}] dev-python/httpx-sse[${PYTHON_USEDEP}]  )
	...
	lg_thinq? ( ~dev-python/thinqconnect-1.0.5[${PYTHON_USEDEP}] )
	...
	scrape? ( ~dev-python/beautifulsoup4-4.12.3[${PYTHON_USEDEP}] dev-python/lxml[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartapp-0.3.5[${PYTHON_USEDEP}] ~dev-python/pysmartthings-3.2.8[${PYTHON_USEDEP}] dev-python/aiosseclient[${PYTHON_USEDEP}]  )
	...
	workday? ( ~dev-python/holidays-0.78[${PYTHON_USEDEP}] )
