...
RDEPEND="${RDEPEND}
	...
	bluetooth? ( ~dev-python/bleak-1.0.1[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.0.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.0.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.2[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.1[${PYTHON_USEDEP}] ~dev-python/habluetooth-4.0.1[${PYTHON_USEDEP}] ~dev-python/aiousbwatcher-1.1.1[${PYTHON_USEDEP}]   )
	...
	esphome? ( ~dev-python/aioesphomeapi-37.0.2[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.1.0[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-6.1.6[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] ~dev-python/ical-10.0.4[${PYTHON_USEDEP}] )
	...
	local_calendar? ( ~dev-python/ical-10.0.4[${PYTHON_USEDEP}] )
	local_todo? ( ~dev-python/ical-10.0.4[${PYTHON_USEDEP}] )
	...
	shelly? ( ~dev-python/aioshelly-13.7.2[${PYTHON_USEDEP}] )
	...
	tesla_fleet? ( ~dev-python/tesla-fleet-api-1.2.2[${PYTHON_USEDEP}] )
	tesla_wall_connector? ( ~dev-python/tesla-wall-connector-1.0.2[${PYTHON_USEDEP}] )
	teslemetry? ( ~dev-python/tesla-fleet-api-1.2.2[${PYTHON_USEDEP}] )
	tessie? ( ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-1.2.2[${PYTHON_USEDEP}] )
