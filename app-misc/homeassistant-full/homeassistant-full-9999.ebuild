...
RDEPEND="${RDEPEND}
	...
	aemet? ( ~dev-python/AEMET-OpenData-0.5.2[${PYTHON_USEDEP}] )
	aftership? ( ~dev-python/pyaftership-21.11.0[${PYTHON_USEDEP}] )
	agent_dvr? ( ~dev-python/agent-py-0.0.23[${PYTHON_USEDEP}] )
	airgradient? ( ~dev-python/airgradient-0.4.3[${PYTHON_USEDEP}] )
	...
	airtouch5? ( ~dev-python/airtouch5py-0.2.8[${PYTHON_USEDEP}] )
	airvisual? ( ~dev-python/pyairvisual-2023.8.1[${PYTHON_USEDEP}] )
	airvisual_pro? ( ~dev-python/pyairvisual-2023.8.1[${PYTHON_USEDEP}] )
	airzone? ( ~dev-python/aioairzone-0.7.6[${PYTHON_USEDEP}] )
	airzone_cloud? ( ~dev-python/aioairzone-cloud-0.5.1[${PYTHON_USEDEP}] )
	...
	amazon_polly? ( ~dev-python/boto3-1.34.51[${PYTHON_USEDEP}] )
	ambee? ( ~dev-python/ambee-0.4.0[${PYTHON_USEDEP}] )
	amberelectric? ( ~dev-python/amberelectric-1.1.0[${PYTHON_USEDEP}] )
	ambiclimate? ( ~dev-python/Ambiclimate-0.2.1[${PYTHON_USEDEP}] )
	ambient_network? ( ~dev-python/aioambient-2024.1.0[${PYTHON_USEDEP}] )
	...
	anova? ( ~dev-python/anova-wifi-0.12.0[${PYTHON_USEDEP}] )
	...
	aprilaire? ( ~dev-python/pyaprilaire-0.7.0[${PYTHON_USEDEP}] )
	aprs? ( ~dev-python/aprslib-0.7.2[${PYTHON_USEDEP}] ~sci-geosciences/geopy-2.3.0 )
	apsystems? ( ~dev-python/apsystems-ez1-1.3.1[${PYTHON_USEDEP}] )
	...
	arve? ( ~dev-python/asyncarve-0.0.9[${PYTHON_USEDEP}] )
	aseko_pool_live? ( ~dev-python/aioaseko-0.1.1[${PYTHON_USEDEP}] )
	assist_pipeline? ( ~dev-python/webrtc-noise-gain-1.2.3[${PYTHON_USEDEP}] )
	...
	aws? ( ~dev-python/aiobotocore-2.12.1[${PYTHON_USEDEP}] )
	axis? ( ~dev-python/axis-61[${PYTHON_USEDEP}] )
	azure_data_explorer? ( ~dev-python/azure-kusto-ingest-3.1.0[${PYTHON_USEDEP}] ~dev-python/azure-kusto-data-3.1.0[${PYTHON_USEDEP}] )
	...
	balboa? ( ~dev-python/pybalboa-1.0.1[${PYTHON_USEDEP}] )
	bang_olufsen? ( ~dev-python/mozart-api-3.4.1.8.5[${PYTHON_USEDEP}] )
	...
	bthome? ( ~dev-python/bthome-ble-3.8.1[${PYTHON_USEDEP}] )
	...
	discovergy? ( ~dev-python/pydiscovergy-3.0.1[${PYTHON_USEDEP}] )
	...
	dsmr? ( ~dev-python/dsmr-parser-1.3.1[${PYTHON_USEDEP}] )
	dunehd? ( ~dev-python/pdunehd-1.3.2[${PYTHON_USEDEP}] )
	duotecno? ( ~dev-python/pyDuotecno-2024.5.1[${PYTHON_USEDEP}] )
	...
	easyenergy? ( ~dev-python/easyenergy-2.1.1[${PYTHON_USEDEP}] )
	...
	econet? ( ~dev-python/pyeconet-0.1.22[${PYTHON_USEDEP}] )
	ecovacs? ( ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] ~dev-python/deebot-client-7.3.0[${PYTHON_USEDEP}] )
	...
	electrasmart? ( ~dev-python/pyElectra-1.2.1[${PYTHON_USEDEP}] )
	...
	emby? ( ~dev-python/pyEmby-1.9[${PYTHON_USEDEP}] )
	...
	eq3btsmart? ( ~dev-python/eq3btsmart-1.1.8[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-1.0.0[${PYTHON_USEDEP}] )
	...
	flipr? ( ~dev-python/flipr-api-1.5.1[${PYTHON_USEDEP}] )
	...
	fyta? ( ~dev-python/fyta-cli-0.4.1[${PYTHON_USEDEP}] )
	garages_amsterdam? ( ~dev-python/odp-amsterdam-6.0.1[${PYTHON_USEDEP}] )
	gardena_bluetooth? ( ~dev-python/gardena-bluetooth-1.4.2[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-6.0.4[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] ~dev-python/ical-8.0.1[${PYTHON_USEDEP}] )
	...
	google_generative_ai_conversation? ( ~dev-python/google-generativeai-0.6.0[${PYTHON_USEDEP}] ~dev-python/voluptuous-openapi-0.0.4[${PYTHON_USEDEP}] )
	...
	govee_ble? ( ~dev-python/govee-ble-0.31.2[${PYTHON_USEDEP}] )
	govee_light_local? ( ~dev-python/govee-local-api-1.5.0[${PYTHON_USEDEP}] )
	...
	homewizard? ( ~dev-python/python-homewizard-energy-6.0.0[${PYTHON_USEDEP}] )
	...
	husqvarna_automower? ( ~dev-python/aioautomower-2024.5.1[${PYTHON_USEDEP}] )
	...
	idasen_desk? ( ~dev-python/idasen-ha-2.5.3[${PYTHON_USEDEP}] )
	...
	imgw_pib? ( ~dev-python/imgw-pib-1.0.5[${PYTHON_USEDEP}] )
	...
	justnimbus? ( ~dev-python/justnimbus-0.7.3[${PYTHON_USEDEP}] )
	jvc_projector? ( ~dev-python/pyjvcprojector-1.0.11[${PYTHON_USEDEP}] )
	...
	lacrosse_view? ( ~dev-python/lacrosse-view-1.0.1[${PYTHON_USEDEP}] )
	lamarzocco? ( ~dev-python/lmcloud-0.4.35[${PYTHON_USEDEP}] )
	...
	ld2410_ble? ( ~dev-python/bluetooth-data-tools-1.19.0[${PYTHON_USEDEP}] ~dev-python/ld2410-ble-0.1.1[${PYTHON_USEDEP}] )
	leaone? ( ~dev-python/leaone-ble-0.1.0[${PYTHON_USEDEP}] )
	led_ble? ( ~dev-python/bluetooth-data-tools-1.19.0[${PYTHON_USEDEP}] ~dev-python/led-ble-1.0.1[${PYTHON_USEDEP}] )
	...
	lutron? ( ~dev-python/pylutron-0.2.13[${PYTHON_USEDEP}] )
	lutron_caseta? ( ~dev-python/pylutron-caseta-0.20.0[${PYTHON_USEDEP}] )
	lw12wifi? ( ~dev-python/lw12-0.9.2[${PYTHON_USEDEP}] )
	lyft? ( ~dev-python/lyft_rides-0.2[${PYTHON_USEDEP}] )
	lyric? ( ~dev-python/aiolyric-1.1.0[${PYTHON_USEDEP}] )
	...
	monzo? ( ~dev-python/monzopy-1.2.0[${PYTHON_USEDEP}] )
	mopeka? ( ~dev-python/mopeka-iot-ble-0.7.0[${PYTHON_USEDEP}] )
	mosquitto? ( app-misc/mosquitto )
	motionblinds_ble? ( ~dev-python/motionblindsble-0.0.9[${PYTHON_USEDEP}] )
	motioneye? ( ~dev-python/motioneye-client-0.3.14[${PYTHON_USEDEP}] )
	motionmount? ( ~dev-python/python-MotionMount-1.0.0[${PYTHON_USEDEP}] )
	motion_blinds? ( ~dev-python/motionblinds-0.6.23[${PYTHON_USEDEP}] )
	...
	nam? ( ~dev-python/nettigo-air-monitor-3.1.0[${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/google-nest-sdm-4.0.5[${PYTHON_USEDEP}] )
	...
	nextbus? ( ~dev-python/py-nextbusnext-1.0.2[${PYTHON_USEDEP}] )
	nextcloud? ( ~dev-python/nextcloudmonitor-1.5.0[${PYTHON_USEDEP}] )
	nextdns? ( ~dev-python/nextdns-3.0.0[${PYTHON_USEDEP}] )
	nfandroidtv? ( ~dev-python/notifications-android-tv-0.1.5[${PYTHON_USEDEP}] )
	nibe_heatpump? ( ~dev-python/nibe-2.8.0[${PYTHON_USEDEP}] )
	...
	ollama? ( ~dev-python/ollama-hass-0.1.7[${PYTHON_USEDEP}] )
	...
	openai_conversation? ( ~dev-python/openai-1.3.8[${PYTHON_USEDEP}] ~dev-python/voluptuous-openapi-0.0.4[${PYTHON_USEDEP}] )
	...
	opensky? ( ~dev-python/python-opensky-1.0.0[${PYTHON_USEDEP}] )
	opentherm_gw? ( ~dev-python/pyotgw-2.2.0[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.4.7[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.13.11[${PYTHON_USEDEP}] )
	...
	p1_monitor? ( ~dev-python/p1monitor-3.0.0[${PYTHON_USEDEP}] )
	...
	point? ( ~dev-python/pypoint-2.3.2[${PYTHON_USEDEP}] )
	...
	pure_energie? ( ~dev-python/gridnet-5.0.0[${PYTHON_USEDEP}] )
	...
	rainforest_raven? ( ~dev-python/aioraven-0.5.3[${PYTHON_USEDEP}] )
	...
	rdw? ( ~dev-python/vehicle-2.2.1[${PYTHON_USEDEP}] )
	...
	refoss? ( ~dev-python/refoss-ha-1.2.0[${PYTHON_USEDEP}] )
	...
	renault? ( ~dev-python/renault-api-0.2.3[${PYTHON_USEDEP}] )
	renson? ( ~dev-python/renson-endura-delta-1.7.1[${PYTHON_USEDEP}] )
	reolink? ( ~dev-python/reolink-aio-0.9.1[${PYTHON_USEDEP}] )
	...
	route53? ( ~dev-python/boto3-1.34.51[${PYTHON_USEDEP}] )
	...
	ruckus_unleashed? ( ~dev-python/aioruckus-0.34[${PYTHON_USEDEP}] )
	russound_rio? ( ~dev-python/russound-rio-1.0.0[${PYTHON_USEDEP}] )
	...
	schlage? ( ~dev-python/pyschlage-2024.2.0[${PYTHON_USEDEP}] )
	...
	serial? ( ~dev-python/pyserial-asyncio-fast-0.11[${PYTHON_USEDEP}] )
	...
	sisyphus? ( ~dev-python/sisyphus-control-3.1.3[${PYTHON_USEDEP}] )
	...
	sunweg? ( ~dev-python/sunweg-2.1.1[${PYTHON_USEDEP}] )
	...
	switcher_kis? ( ~dev-python/aioswitcher-3.4.3[${PYTHON_USEDEP}] )
	...
	system_bridge? ( ~dev-python/systembridgeconnector-4.0.3[${PYTHON_USEDEP}] ~dev-python/systembridgemodels-4.0.4[${PYTHON_USEDEP}] )
	tado? ( ~dev-python/python-tado-0.17.4[${PYTHON_USEDEP}] )
	tahoma? ( ~dev-python/tahoma-api-0.0.16[${PYTHON_USEDEP}] )
	tailscale? ( ~dev-python/tailscale-0.6.0[${PYTHON_USEDEP}] )
	tailwind? ( ~dev-python/gotailwind-0.2.3[${PYTHON_USEDEP}] )
	tami4? ( ~dev-python/Tami4EdgeAPI-2.1[${PYTHON_USEDEP}] )
	...
	technove? ( ~dev-python/python-technove-1.2.2[${PYTHON_USEDEP}] )
	ted5000? ( ~dev-python/xmltodict-0.13.0[${PYTHON_USEDEP}] )
	tedee? ( ~dev-python/pytedee-async-0.2.17[${PYTHON_USEDEP}] )
	telegram_bot? ( ~dev-python/python-telegram-bot-21.0.1[${PYTHON_USEDEP}] )
	...
	teslemetry? ( ~dev-python/tesla-fleet-api-0.5.12[${PYTHON_USEDEP}] )
	tessie? ( ~dev-python/tessie-api-0.0.9[${PYTHON_USEDEP}] )
	tfiac? ( ~dev-python/pytfiac-0.4[${PYTHON_USEDEP}] )
	thermobeacon? ( ~dev-python/thermobeacon-ble-0.6.2[${PYTHON_USEDEP}] )
	...
	thread? ( ~dev-python/python-otbr-api-2.6.0[${PYTHON_USEDEP}] ~dev-python/pyroute2-0.7.5[${PYTHON_USEDEP}] )
	tibber? ( ~dev-python/pyTibber-0.28.2[${PYTHON_USEDEP}] )
	...
	tplink_omada? ( ~dev-python/tplink-omada-client-1.3.12[${PYTHON_USEDEP}] )
	...
	tractive? ( ~dev-python/aiotractive-0.5.6[${PYTHON_USEDEP}] )
	tradfri? ( ~dev-python/pytradfri-9.0.1[async,${PYTHON_USEDEP}] )
	trafikverket_camera? ( ~dev-python/pytrafikverket-0.3.10[${PYTHON_USEDEP}] )
	trafikverket_ferry? ( ~dev-python/pytrafikverket-0.3.10[${PYTHON_USEDEP}] )
	trafikverket_train? ( ~dev-python/pytrafikverket-0.3.10[${PYTHON_USEDEP}] )
	trafikverket_weatherstation? ( ~dev-python/pytrafikverket-0.3.10[${PYTHON_USEDEP}] )
	...
	twitch? ( ~dev-python/twitchAPI-4.0.0[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/uiprotect-1.7.2[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.8[${PYTHON_USEDEP}] )
	unifi_direct? ( ~dev-python/unifi-ap-0.0.1[${PYTHON_USEDEP}] )
	upb? ( ~dev-python/upb-lib-0.5.6[${PYTHON_USEDEP}] )
	...
	v2c? ( ~dev-python/pytrydan-0.6.1[${PYTHON_USEDEP}] )
	...
	vesync? ( ~dev-python/pyvesync-2.1.10[${PYTHON_USEDEP}] )
	...
	vlc_telnet? ( ~dev-python/aiovlc-0.3.2[${PYTHON_USEDEP}] )
	...
	wallbox? ( ~dev-python/wallbox-0.6.0[${PYTHON_USEDEP}] )
	...
	weatherflow_cloud? ( ~dev-python/weatherflow4py-0.2.21[${PYTHON_USEDEP}] )
	...
	wolflink? ( ~dev-python/wolf-comm-0.0.8[${PYTHON_USEDEP}] )
	...
	yolink? ( ~dev-python/yolink-api-0.4.4[${PYTHON_USEDEP}] )
	youless? ( ~dev-python/youless-api-1.1.1[${PYTHON_USEDEP}] )
