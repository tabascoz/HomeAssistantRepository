...
RDEPEND="${RDEPEND}
	...
	~dev-python/dbus-fast-2.44.5[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
    ...
    bluetooth? ( ~dev-python/bleak-1.1.1[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.4.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.1.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.4[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.5[${PYTHON_USEDEP}] ~dev-python/habluetooth-5.7.0[${PYTHON_USEDEP}] )
    ...
    caldav? ( ~dev-python/caldav-1.6.0[${PYTHON_USEDEP}] )
    ...
    esphome? ( ~dev-python/aioesphomeapi-42.6.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.4.0[${PYTHON_USEDEP}] )
    ...
    google? ( ~dev-python/gcal-sync-8.0.0[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] ~dev-python/ical-11.0.0[${PYTHON_USEDEP}] )
    ...
    hardware? ( ~dev-python/psutil-home-assistant-0.0.1[${PYTHON_USEDEP}] ~dev-python/universal-silabs-flasher-0.37[${PYTHON_USEDEP}] ~dev-python/ha-silabs-firmware-client-0.2.0[${PYTHON_USEDEP}] )
    ...
    home_connect? ( ~dev-python/aiohomeconnect-0.23.0[${PYTHON_USEDEP}] )
    ...
    homematicip_cloud? ( ~dev-python/homematicip-2.3.1[${PYTHON_USEDEP}] )
    ...
    hunterdouglas_powerview? ( ~dev-python/aiopvapi-3.2.1[${PYTHON_USEDEP}] )
    ...
    knx? ( ~dev-python/xknx-3.10.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.2[${PYTHON_USEDEP}] ~dev-python/knx-frontend-2025.10.31.195356[${PYTHON_USEDEP}] )
    ...
    lamarzocco? ( ~dev-python/pylamarzocco-2.1.2[${PYTHON_USEDEP}] )
    ...
    local_calendar? ( ~dev-python/ical-11.0.0[${PYTHON_USEDEP}] )
    local_todo? ( ~dev-python/ical-11.0.0[${PYTHON_USEDEP}] )
    ...
    mealie? ( ~dev-python/aiomealie-1.0.1[${PYTHON_USEDEP}] )
    ...
    mill? ( ~dev-python/millheater-0.14.0[${PYTHON_USEDEP}] ~dev-python/mill-local-0.3.0[${PYTHON_USEDEP}] )
    ...
    openai_conversation? ( ~dev-python/openai-2.2.0[${PYTHON_USEDEP}] )
    ...
    pvoutput? ( ~dev-python/pvo-2.2.0[${PYTHON_USEDEP}] )
    ...
    reolink? ( ~dev-python/reolink-aio-0.16.4[${PYTHON_USEDEP}] )
    ...
    roborock? ( ~dev-python/python-roborock-3.7.0[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.4[${PYTHON_USEDEP}] )	
    ...
    shelly? ( ~dev-python/aioshelly-13.16.0[${PYTHON_USEDEP}] )
    ...
    smartthings? ( ~dev-python/pysmartthings-3.3.1[${PYTHON_USEDEP}] )
    ...
    switchbot? ( ~dev-python/PySwitchbot-0.72.1[${PYTHON_USEDEP}] )
    ...
    vesync? ( ~dev-python/pyvesync-3.1.4[${PYTHON_USEDEP}] )
    vicare? ( ~dev-python/PyViCare-2.54.0[${PYTHON_USEDEP}] )
    ...
    xbox? ( ~dev-python/python-xbox-0.1.0[${PYTHON_USEDEP}] )
    xbox_live? ( ~dev-python/python-xbox-0.1.0[${PYTHON_USEDEP}] )
    ...
    zha? ( ~dev-python/universal-silabs-flasher-0.0.37[${PYTHON_USEDEP}] ~dev-python/zha-0.0.78[${PYTHON_USEDEP}] )
...
##integrations to be added: - meteo.be, probeplus, iometer, citybikes, nintendoparental, victron_remote_monitoring, nordpool, airthings-ble, onewire (ownet), openrgb, actron_air, router_b_smart_meter, prowl, thethingsnetwork (ttn_client), sunricher dali , fing, inels, pooldose, openrouter, snawp, onedrive, backblase_b2, vegehub, watergate, ledpot, pyrefly_iii, 
