...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20250507.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	dnsip? ( ~dev-python/aiodns-3.3.0[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartapp-0.3.5[${PYTHON_USEDEP}] ~dev-python/pysmartthings-3.2.1[${PYTHON_USEDEP}] dev-python/aiosseclient[${PYTHON_USEDEP}]  )
	...
	xiaomi_ble? ( ~dev-python/xiaomi-ble-0.38.0[${PYTHON_USEDEP}] )
