...
RDEPEND="${RDEPEND}
	...
	bluetooth? ( ~dev-python/bleak-0.22.3[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-3.10.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.1[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.1[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.1[${PYTHON_USEDEP}] ~dev-python/habluetooth-3.48.2[${PYTHON_USEDEP}] ~dev-python/aiousbwatcher-1.1.1[${PYTHON_USEDEP}]   )
	...
	compensation? ( ~dev-python/numpy-2.2.6[${PYTHON_USEDEP}] )
	...
	iqvia? ( ~dev-python/numpy-2.2.6[${PYTHON_USEDEP}] ~dev-python/pyiqvia-2022.4.0[${PYTHON_USEDEP}] )
	...
	stream? ( ~dev-python/PyTurboJPEG-1.7.5[${PYTHON_USEDEP}] ~dev-python/ha-av-10.1.1-r1[${PYTHON_USEDEP}] ~dev-python/numpy-2.2.6[${PYTHON_USEDEP}] )
	...
	trend? ( ~dev-python/numpy-2.2.6[${PYTHON_USEDEP}] )
