...
RDEPEND="${RDEPEND}
	...
	~dev-python/habluetooth-3.38.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	cloud? ( ~dev-python/hass-nabucasa-0.92.0[${PYTHON_USEDEP}] )
	...
	doods? ( ~dev-python/pydoods-1.0.2[${PYTHON_USEDEP}] ~dev-python/pillow-11.2.0[${PYTHON_USEDEP}] )
	...
	esphome? ( ~dev-python/aioesphomeapi-29.8.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.2.3[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-2.13.1[${PYTHON_USEDEP}] )
	...
	generic? ( ~dev-python/ha-av-10.1.1-r1[${PYTHON_USEDEP}] ~dev-python/pillow-11.2.0[${PYTHON_USEDEP}] )
	...
	homekit? ( ~dev-python/HAP-python-4.9.1[${PYTHON_USEDEP}] ~dev-python/fnv-hash-fast-1.2.6[${PYTHON_USEDEP}] ~dev-python/pyqrcode-1.2.1[${PYTHON_USEDEP}] ~dev-python/base36-0.1.1[${PYTHON_USEDEP}] )
	...
	image? ( ~dev-python/pillow-11.2.0[${PYTHON_USEDEP}] )
	image_upload? ( ~dev-python/pillow-11.2.0[${PYTHON_USEDEP}] )
	...
	inkbird? ( ~dev-python/inkbird-ble-0.10.1[${PYTHON_USEDEP}] )
	...
	matrix? ( ~dev-python/matrix-nio-0.25.2[${PYTHON_USEDEP}] ~dev-python/pillow-11.2.0[${PYTHON_USEDEP}] )
	...
	proxy? ( ~dev-python/pillow-11.2.0[${PYTHON_USEDEP}] )
	...
	qrcode? ( ~dev-python/pillow-11.2.0[${PYTHON_USEDEP}] ~dev-python/pyzbar-0.1.7[${PYTHON_USEDEP}] )
	...
	recorder? ( dev-python/sqlalchemy[${PYTHON_USEDEP}] ~dev-python/fnv-hash-fast-1.2.6[${PYTHON_USEDEP}] ~dev-python/psutil-home-assistant-0.0.1[${PYTHON_USEDEP}] )
	...
	scrape? ( ~dev-python/beautifulsoup4-4.12.3[${PYTHON_USEDEP}] ~dev-python/lxml-5.3.1[${PYTHON_USEDEP}] )
	...
	seven_segments? ( ~dev-python/pillow-11.2.0[${PYTHON_USEDEP}] )
	sfr_box? ( ~dev-python/sfrbox-api-0.0.11[${PYTHON_USEDEP}] )
	sharkiq? ( ~dev-python/sharkiq-1.0.2[${PYTHON_USEDEP}] )
	shelly? ( ~dev-python/aioshelly-13.4.0[${PYTHON_USEDEP}] )
	...
	sighthound? ( ~dev-python/pillow-11.2.0[${PYTHON_USEDEP}] ~dev-python/simplehound-0.3[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartapp-0.3.5[${PYTHON_USEDEP}] ~dev-python/pysmartthings-3.0.2[${PYTHON_USEDEP}] dev-python/aiosseclient[${PYTHON_USEDEP}]  )
