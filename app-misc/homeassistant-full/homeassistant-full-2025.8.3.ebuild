...
RDEPEND="${RDEPEND}
	...
	~dev-python/habluetooth-5.1.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	bluetooth? ( ~dev-python/bleak-1.0.1[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.3.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.0.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.2[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.3[${PYTHON_USEDEP}] ~dev-python/habluetooth-5.1.0[${PYTHON_USEDEP}] ~dev-python/aiousbwatcher-1.1.1[${PYTHON_USEDEP}]   )
