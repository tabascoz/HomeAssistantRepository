...
RDEPEND="${RDEPEND}
	...
	~dev-python/hass-nabucasa-0.111.2[${PYTHON_USEDEP}]
	~dev-python/hassil-3.1.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-bluetooth-2.0.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-frontend-20250811.1[${PYTHON_USEDEP}]
	~dev-python/home-assistant-intents-2025.7.30[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	cloud? ( ~dev-python/hass-nabucasa-1.0.0[${PYTHON_USEDEP}] )
	...
	tesla_fleet? ( ~dev-python/tesla-fleet-api-1.2.3[${PYTHON_USEDEP}] )
	tesla_wall_connector? ( ~dev-python/tesla-wall-connector-1.0.2[${PYTHON_USEDEP}] )
	teslemetry? ( ~dev-python/tesla-fleet-api-1.2.3[${PYTHON_USEDEP}] )
