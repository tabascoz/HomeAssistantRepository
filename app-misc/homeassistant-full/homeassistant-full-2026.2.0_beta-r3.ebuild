...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20260128.5[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	amazon_devices? ( ~dev-python/aioamazondevices-11.1.1[${PYTHON_USEDEP}] )
	...
	compit? ( ~dev-python/compit-inext-api-0.7.0[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-8.0.0[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] ~dev-python/ical-12.1.3[${PYTHON_USEDEP}] )
	...
	local_calendar? ( ~dev-python/ical-12.1.3[${PYTHON_USEDEP}] )
	local_todo? ( ~dev-python/ical-12.1.3[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.18.2[${PYTHON_USEDEP}] )
	...
	roborock? ( ~dev-python/python-roborock-4.12.0[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.4[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/uiprotect-10.1.0[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
