# Copyright 1999-2024 Gentoo Author	
...
RDEPEND="${RDEPEND}
	...
	~dev-python/aiohasupervisor-0.3.2[${PYTHON_USEDEP}]
	...
	>=dev-python/btlewrap-0.1.1[${PYTHON_USEDEP}]
	...
	~dev-python/hass-nabucasa-1.1.1[${PYTHON_USEDEP}]
	~dev-python/hassil-3.2.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-bluetooth-2.0.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-frontend-20250903.3[${PYTHON_USEDEP}]
	~dev-python/home-assistant-intents-2025.9.3[${PYTHON_USEDEP}]
	...
	~dev-python/hass-web-proxy-lib-0.0.7[${PYTHON_USEDEP}]
	...
	dev-python/aioopenexchangerates[${PYTHON_USEDEP}]
	dev-python/tuya-iot-py-sdk[${PYTHON_USEDEP}]
...
# cronsim webrtc-models  spotifyaio propcache
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	accuweather? ( ~dev-python/accuweather-4.2.1[${PYTHON_USEDEP}] )
	...
	bluetooth? ( ~dev-python/bleak-1.1.0[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.4.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.1.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.2[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.3[${PYTHON_USEDEP}] ~dev-python/habluetooth-5.6.4[${PYTHON_USEDEP}] ~dev-python/aiousbwatcher-1.1.1[${PYTHON_USEDEP}]   )
	...
	bthome? ( ~dev-python/bthome-ble-3.13.1[${PYTHON_USEDEP}] )
	...
	cloud? ( ~dev-python/hass-nabucasa-1.1.1[${PYTHON_USEDEP}] )
	...
	dlna_dmr? ( ~dev-python/async-upnp-client-0.45.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.4[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] ~dev-python/deebot-client-8.4.0[${PYTHON_USEDEP}] )
	ecowitt? ( ~dev-python/aioecowitt-2025.9.1[${PYTHON_USEDEP}] )
	...
	esphome? ( ~dev-python/aioesphomeapi-41.4.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.2.0[${PYTHON_USEDEP}] )
	...
	homekit? ( ~dev-python/HAP-python-4.9.1[${PYTHON_USEDEP}] ~dev-python/fnv-hash-fast-1.5.0[${PYTHON_USEDEP}] ~dev-python/pyqrcode-1.2.1[${PYTHON_USEDEP}] ~dev-python/base36-0.1.1[${PYTHON_USEDEP}] )
	homekit_controller? ( ~dev-python/aiohomekit-3.2.17[${PYTHON_USEDEP}] )
	...
	home_connect? ( ~dev-python/homeconnect-0.8.0[${PYTHON_USEDEP}] ~dev-python/aiohomeconnect-0.19.0[${PYTHON_USEDEP}] dev-python/httpx-sse[${PYTHON_USEDEP}]  )
	...
	http? ( ~dev-python/aiohttp-cors-0.8.1[${PYTHON_USEDEP}] ~dev-python/aiohttp-fast-url-dispatcher-0.3.0[${PYTHON_USEDEP}] ~dev-python/aiohttp-zlib-ng-0.3.1[${PYTHON_USEDEP}] )
	...
	hue? ( ~dev-python/aiohue-4.7.5[${PYTHON_USEDEP}] )
	...
	iron_os? ( ~dev-python/pynecil-0.2.0[${PYTHON_USEDEP}] )
	...
	libre_hardware_monitor? ( ~dev-python/librehardwaremonitor-api-1.3.1[${PYTHON_USEDEP}] )
	...
	media_extractor? ( ~net-misc/yt-dlp-2025.9.5 )
	...
	nibe_heatpump? ( ~dev-python/nibe-2.18.0[${PYTHON_USEDEP}] )
	...
	onvif? ( ~dev-python/onvif-zeep-async-3.1.12[${PYTHON_USEDEP}] ~dev-python/WSDiscovery-2.1.2[${PYTHON_USEDEP}] )
	...
	pushover? ( ~dev-python/pushover_complete-1.2.0[${PYTHON_USEDEP}] )
	pvoutput? ( ~dev-python/pvo-2.2.0[${PYTHON_USEDEP}] )
	pvpc_hourly_pricing? ( ~dev-python/aiopvpc-4.2.2[${PYTHON_USEDEP}] )
	python_script? ( ~dev-python/RestrictedPython-8.0[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.15.1[${PYTHON_USEDEP}] )
	...
	samsungtv? ( ~dev-python/getmac-0.9.4[${PYTHON_USEDEP}] ~dev-python/samsungctl-0.7.1[${PYTHON_USEDEP}] ~dev-python/samsungtvws-2.7.2[async,encrypted,${PYTHON_USEDEP}] ~dev-python/wakeonlan-3.1.0[${PYTHON_USEDEP}] ~dev-python/async-upnp-client-0.45.0[${PYTHON_USEDEP}] )
	...
	scrape? ( ~dev-python/beautifulsoup4-4.13.3[${PYTHON_USEDEP}] dev-python/lxml[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartapp-0.3.5[${PYTHON_USEDEP}] ~dev-python/pysmartthings-3.2.9[${PYTHON_USEDEP}] dev-python/aiosseclient[${PYTHON_USEDEP}]  )
	...
	tibber? ( ~dev-python/pyTibber-0.31.7[${PYTHON_USEDEP}] )
	...
	upnp? ( ~dev-python/async-upnp-client-0.45.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.4[${PYTHON_USEDEP}] )
	...
	vesync? ( ~dev-python/pyvesync-3.0.0_beta8[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/universal-silabs-flasher-0.0.32[${PYTHON_USEDEP}] ~dev-python/zha-0.0.71[${PYTHON_USEDEP}] )
...
##tb added - Droplet,(ai)ntfy,(py)Homee, ohme(py), asusrouter(asuswrt), volvocars, ubiquity airos, brother, aladdin connect, aioamazondevices, roborock, pymiele , emoncms, pyratelimiter, imeon inverter, aioapaccess
## thchanged habitica(lib), zabbix , lamarzocco
