...
RDEPEND="${RDEPEND}
	...
	~dev-python/annotatedyaml-1.0.0[${PYTHON_USEDEP}]
	...
	~dev-python/hass-nabucasa-1.4.0[${PYTHON_USEDEP}]
	~dev-python/hassil-3.2.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-bluetooth-2.0.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-frontend-20251001.4[${PYTHON_USEDEP}]
	~dev-python/home-assistant-intents-2025.10.1[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
    ...
    airos? ( ~dev-python/airos-0.5.6[${PYTHON_USEDEP}] )
    ...
    airzone? ( ~dev-python/aioairzone-1.0.1[${PYTHON_USEDEP}] )
    ...
    amazon_devices? ( ~dev-python/aioamazondevices-6.4.4[${PYTHON_USEDEP}] ) 
    ...
    bluetooth? ( ~dev-python/bleak-1.1.0[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.4.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.1.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.3[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.5[${PYTHON_USEDEP}] ~dev-python/habluetooth-5.7.0[${PYTHON_USEDEP}] )
    ...
    bthome? ( ~dev-python/bthome-ble-3.14.2[${PYTHON_USEDEP}] )
    ...
    cloud? ( ~dev-python/hass-nabucasa-1.4.0[${PYTHON_USEDEP}] )
    ...
    cync? ( ~dev-python/pycync-0.4.1[${PYTHON_USEDEP}] )
    ...
    droplet? ( ~dev-python/pydroplet-2.3.3[${PYTHON_USEDEP}] )
    ...
    ecovacs? ( ~dev-python/py-sucks-0.9.11[${PYTHON_USEDEP}] ~dev-python/deebot-client-15.1.0[${PYTHON_USEDEP}] )
    ecowitt? ( ~dev-python/aioecowitt-2025.9.2[${PYTHON_USEDEP}] )
    eddystone_temperature? ( ~dev-python/beacontools-2.1.0[${PYTHON_USEDEP}] )
    ...
    eheimdigital? ( ~dev-python/eheimdigital-1.3.0[${PYTHON_USEDEP}] )
    ...
    esphome? ( ~dev-python/aioesphomeapi-42.0.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.4.0[${PYTHON_USEDEP}] )
    ...
    foscam? ( ~dev-python/libpyfoscamcgi-0.0.8[${PYTHON_USEDEP}] )
    ...
    hardware? ( ~dev-python/psutil-home-assistant-0.0.1[${PYTHON_USEDEP}] ~dev-python/universal-silabs-flasher-0.0.35[${PYTHON_USEDEP}] ~dev-python/ha-silabs-firmware-client-0.2.0[${PYTHON_USEDEP}] )
    ...
    holiday? ( ~dev-python/holidays-0.82[${PYTHON_USEDEP}] ~dev-python/Babel-2.15.0[${PYTHON_USEDEP}] )
    home_connect? ( ~dev-python/homeconnect-0.8.0[${PYTHON_USEDEP}] ~dev-python/aiohomeconnect-0.22.0[${PYTHON_USEDEP}] dev-python/httpx-sse[${PYTHON_USEDEP}]  )
    ...
    homematicip_cloud? ( ~dev-python/homematicip-2.3.0[${PYTHON_USEDEP}] )
    ...
    husqvarna_automower? ( ~dev-python/aioautomower-2.2.1[${PYTHON_USEDEP}] )
    ...
    knx? ( ~dev-python/xknx-3.10.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.2[${PYTHON_USEDEP}] ~dev-python/knx-frontend-2025.10.9.185845[${PYTHON_USEDEP}] )
    ...
    ld2410_ble? ( ~dev-python/bluetooth-data-tools-1.28.3[${PYTHON_USEDEP}] ~dev-python/ld2410-ble-0.1.1[${PYTHON_USEDEP}] )
    leaone? ( ~dev-python/leaone-ble-0.1.0[${PYTHON_USEDEP}] )
    led_ble? ( ~dev-python/bluetooth-data-tools-1.28.3[${PYTHON_USEDEP}] ~dev-python/led-ble-1.0.2[${PYTHON_USEDEP}] )
    ...
    libre_hardware_monitor? ( ~dev-python/librehardwaremonitor-api-1.4.0[${PYTHON_USEDEP}] )
    ...
    litterrobot? ( ~dev-python/pylitterbot-2024.2.4[${PYTHON_USEDEP}] )
    ...
    media_extractor? ( ~net-misc/yt-dlp-2025.9.26 )
    ...
    miele? ( ~dev-python/pymiele-0.1.0[${PYTHON_USEDEP}] )
    ...
    opower? ( ~dev-python/opower-0.15.7[${PYTHON_USEDEP}] )
    ...
    playstation_network? ( ~dev-python/pyrate-limiter-3.9.0[${PYTHON_USEDEP}] ) 
    ...
    plugwise? ( ~dev-python/plugwise-1.8.1[${PYTHON_USEDEP}] )
    pocketcasts? ( ~dev-python/pycketcasts-1.0.1[${PYTHON_USEDEP}] )
    point? ( ~dev-python/pypoint-3.0.0[${PYTHON_USEDEP}] )
    poolsense? ( ~dev-python/poolsense-0.0.8[${PYTHON_USEDEP}] )
    portainer? ( ~dev-python/pyportainer-1.0.3[${PYTHON_USEDEP}] )
    powerwall? ( ~dev-python/tesla-powerwall-0.5.2[${PYTHON_USEDEP}] )
    private_ble_device? ( ~dev-python/bluetooth-data-tools-1.28.3[${PYTHON_USEDEP}] )
    ...
    python_script? ( ~dev-python/RestrictedPython-8.0[${PYTHON_USEDEP}] ~dev-python/croniter-6.0.0[${PYTHON_USEDEP}]  )
    ...
    renault? ( ~dev-python/renault-api-0.4.4[${PYTHON_USEDEP}] )
    renson? ( ~dev-python/renson-endura-delta-1.7.1[${PYTHON_USEDEP}] )
    reolink? ( ~dev-python/reolink-aio-0.16.2[${PYTHON_USEDEP}] )
    ...
    roborock? ( ~dev-python/python-roborock-2.50.2[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.4[${PYTHON_USEDEP}] )	
    ...
    shelly? ( ~dev-python/aioshelly-13.14.0[${PYTHON_USEDEP}] )
    ...
    switchbot? ( ~dev-python/PySwitchbot-0.71.0[${PYTHON_USEDEP}] )
    ...
    systemmonitor? ( ~dev-python/psutil-home-assistant-0.0.1[${PYTHON_USEDEP}] ~dev-python/psutil-7.1.0[${PYTHON_USEDEP}] )
    ...
    telegram_bot? ( ~dev-python/python-telegram-bot-21.5[${PYTHON_USEDEP}] )
    ...
    tesla_fleet? ( ~dev-python/tesla-fleet-api-1.2.4[${PYTHON_USEDEP}] )
    tesla_wall_connector? ( ~dev-python/tesla-wall-connector-1.0.2[${PYTHON_USEDEP}] )
    teslemetry? ( ~dev-python/tesla-fleet-api-1.2.4[${PYTHON_USEDEP}] )
    tessie? ( ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-1.2.3[${PYTHON_USEDEP}] )
    ...
    vesync? ( ~dev-python/pyvesync-3.1.2[${PYTHON_USEDEP}] )
    ...
    vodafone_station? ( ~dev-python/aiovodafone-1.2.1[${PYTHON_USEDEP}] )
    ...
    workday? ( ~dev-python/holidays-0.82[${PYTHON_USEDEP}] )
    ...
    zha? ( ~dev-python/universal-silabs-flasher-0.0.35[${PYTHON_USEDEP}] ~dev-python/zha-0.0.73[${PYTHON_USEDEP}] )
...
##integrations to be added: - meteo.be, probeplus, iometer, citybikes, nintendoparental, victron_remote_monitoring, nordpool, airthings-ble, onewire (ownet), openrgb, actron_air, router_b_smart_meter, prowl
