...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20260107.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-intents-2026.1.6[${PYTHON_USEDEP}]
	...
	~dev-python/pysilero-vad-3.0.1[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	airobot? ( ~dev-python/pyairobotrest-0.2.0[${PYTHON_USEDEP}] )
	airos? ( ~dev-python/airos-0.6.1[${PYTHON_USEDEP}] )
	...
	assist_pipeline? ( ~dev-python/pyspeex-noise-1.0.2[${PYTHON_USEDEP}] ~dev-python/pysilero-vad-3.0.1[${PYTHON_USEDEP}]  )
	...
	bsblan? ( ~dev-python/python-bsblan-3.1.6[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/py-sucks-0.9.11[${PYTHON_USEDEP}] ~dev-python/deebot-client-17.0.1[${PYTHON_USEDEP}] )
	...
	eheimdigital? ( ~dev-python/eheimdigital-1.5.0[${PYTHON_USEDEP}] )
	...
	esphome? ( ~dev-python/aioesphomeapi-43.10.1[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.4.0[${PYTHON_USEDEP}] )
	...
	jvc_projector? ( ~dev-python/pyjvcprojector-1.1.3[${PYTHON_USEDEP}] )
	...
	libre_hardware_monitor? ( ~dev-python/librehardwaremonitor-api-1.8.4[${PYTHON_USEDEP}] )
	...
	nibe_heatpump? ( ~dev-python/nibe-2.21.0[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.16.0[${PYTHON_USEDEP}] )
	...
	portainer? ( ~dev-python/pyportainer-1.0.22[${PYTHON_USEDEP}] )
	...
	roborock? ( ~dev-python/python-roborock-4.2.1[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.4[${PYTHON_USEDEP}] )
	...
	tesla_fleet? ( ~dev-python/tesla-fleet-api-1.4.0[${PYTHON_USEDEP}] )
	tesla_wall_connector? ( ~dev-python/tesla-wall-connector-1.1.0[${PYTHON_USEDEP}] )
	teslemetry? ( ~dev-python/tesla-fleet-api-1.4.0[${PYTHON_USEDEP}] ~dev-python/teslemetry-stream-0.9.0[${PYTHON_USEDEP}] )
	tessie? ( ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-1.4.0[${PYTHON_USEDEP}] )
	...
	tibber? ( ~dev-python/pyTibber-0.34.1[${PYTHON_USEDEP}] )
	...
	tuya? ( ~dev-python/tuya-device-sharing-sdk-0.2.8[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/uiprotect-8.0.0[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
	...
	velbus? ( ~dev-python/velbus-aio-2026.1.1[${PYTHON_USEDEP}] )
	velux? ( ~dev-python/pyvlx-0.2.27[${PYTHON_USEDEP}] )
	...
	vodafone_station? ( ~dev-python/aiovodafone-3.1.1[${PYTHON_USEDEP}] )
	...
	webdav? ( ~dev-python/aiowebdav2-0.5.0[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/universal-silabs-flasher-0.1.2[${PYTHON_USEDEP}] ~dev-python/zha-0.0.83[${PYTHON_USEDEP}] ~dev-python/serialx-0.5.0[${PYTHON_USEDEP}] )
...
## -- todo session
##integrations to be added: (last 2026-01-01 airobot
BDEPEND="${RDEPEND}
	test? (
