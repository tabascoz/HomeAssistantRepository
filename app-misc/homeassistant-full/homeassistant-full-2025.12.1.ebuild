...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20251203.1[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
    ...
    lamarzocco? ( ~dev-python/pylamarzocco-2.2.3[${PYTHON_USEDEP}] )
    ...
    reolink? ( ~dev-python/reolink-aio-0.17.1[${PYTHON_USEDEP}] )
    ...
    roborock? ( ~dev-python/python-roborock-3.10.2[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.4[${PYTHON_USEDEP}] )	
    ...
    unifiprotect? ( ~dev-python/uiprotect-7.33.2[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
    ...
    yale? ( ~dev-python/yalexs-9.0.1[${PYTHON_USEDEP}] ~dev-python/yalexs-ble-3.2.2[${PYTHON_USEDEP}] )
    yale_smart_alarm? ( ~dev-python/yalesmartalarmclient-0.4.3[${PYTHON_USEDEP}] )
    yalexs_ble? ( ~dev-python/yalexs-ble-3.2.2[${PYTHON_USEDEP}] )
...
# essent_dynamic_pricing, music_assistant, incomfort, homelink, freesnapftracker
