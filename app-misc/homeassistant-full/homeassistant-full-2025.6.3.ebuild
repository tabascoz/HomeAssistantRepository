...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20250627.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	bluetooth? ( ~dev-python/bleak-0.22.3[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.0.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.1[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.1[${PYTHON_USEDEP}] ~dev-python/habluetooth-3.49.0[${PYTHON_USEDEP}] ~dev-python/aiousbwatcher-1.1.1[${PYTHON_USEDEP}]   )
	...
	esphome? ( ~dev-python/aioesphomeapi-33.1.1[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-2.16.0[${PYTHON_USEDEP}] )
