...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20251203.3[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	esphome? ( ~dev-python/aioesphomeapi-43.3.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.4.0[${PYTHON_USEDEP}] )
	...
	insteon? ( ~dev-python/pyinsteon-1.6.4[${PYTHON_USEDEP}] ~dev-python/insteon-frontend-home-assistant-0.5.0[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/xknx-3.13.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.2[${PYTHON_USEDEP}] ~dev-python/knx-frontend-2025.12.19.150946[${PYTHON_USEDEP}] )
	...
	lcn? ( ~dev-python/pypck-0.9.8[${PYTHON_USEDEP}] ~dev-python/lcn-frontend-0.2.7[${PYTHON_USEDEP}] )
	...
	roborock? ( ~dev-python/python-roborock-3.19.0[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.4[${PYTHON_USEDEP}] )
	...
	sonos? ( ~dev-python/soco-0.30.13[${PYTHON_USEDEP}] ~dev-python/sonos-websocket-0.1.3[${PYTHON_USEDEP}] ~dev-python/defusedxml-0.7.1[${PYTHON_USEDEP}]  )
	...
	tesla_fleet? ( ~dev-python/tesla-fleet-api-1.2.7[${PYTHON_USEDEP}] )
	tesla_wall_connector? ( ~dev-python/tesla-wall-connector-1.1.0[${PYTHON_USEDEP}] )
	teslemetry? ( ~dev-python/tesla-fleet-api-1.2.7[${PYTHON_USEDEP}] ~dev-python/teslemetry-stream-0.8.2[${PYTHON_USEDEP}] )
	tessie? ( ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-1.2.7[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/universal-silabs-flasher-0.1.2[${PYTHON_USEDEP}] ~dev-python/zha-0.0.81[${PYTHON_USEDEP}] )
...
# essent_dynamic_pricing, music_assistant, incomfort, homelink, freesnapftracker, momonga, sunricher_dali, watts, overseerr
