...
RDEPEND="${RDEPEND}
	...
	~dev-python/habluetooth-5.3.0[${PYTHON_USEDEP}]
	~dev-python/hass-nabucasa-1.1.0[${PYTHON_USEDEP}]
	~dev-python/hassil-3.2.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-bluetooth-2.0.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-frontend-20250903.2[${PYTHON_USEDEP}]
	~dev-python/home-assistant-intents-2025.8.29[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	bluetooth? ( ~dev-python/bleak-1.1.0[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.4.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.1.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.2[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.3[${PYTHON_USEDEP}] ~dev-python/habluetooth-5.3.0[${PYTHON_USEDEP}] ~dev-python/aiousbwatcher-1.1.1[${PYTHON_USEDEP}]   )
	...
	cloud? ( ~dev-python/hass-nabucasa-1.1.0[${PYTHON_USEDEP}] )
	...
	ecowitt? ( ~dev-python/aioecowitt-2025.9.0[${PYTHON_USEDEP}] )
	...
	esphome? ( ~dev-python/aioesphomeapi-39.0.1[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.2.0[${PYTHON_USEDEP}] )
	...
	fritz? ( ~dev-python/fritzconnection-1.13.2[qrcode,${PYTHON_USEDEP}] ~dev-python/xmltodict-0.14.2[${PYTHON_USEDEP}] )
	...
	lg_thinq? ( ~dev-python/thinqconnect-1.0.7[${PYTHON_USEDEP}] )
	...
	mill? ( ~dev-python/millheater-0.11.8[${PYTHON_USEDEP}] ~dev-python/mill-local-0.3.0[${PYTHON_USEDEP}] )
	...
	sharkiq? ( ~dev-python/sharkiq-1.1.1[${PYTHON_USEDEP}] )
	shelly? ( ~dev-python/aioshelly-13.8.0[${PYTHON_USEDEP}] )
	...
	yale? ( ~dev-python/yalexs-8.6.4[${PYTHON_USEDEP}] ~dev-python/yalexs-ble-2.4.3[${PYTHON_USEDEP}] )
