...
RDEPEND="${RDEPEND}
    ...
    asuswrt? ( ~dev-python/aioasuswrt-1.5.2[${PYTHON_USEDEP}] ~dev-python/asusrouter-1.21.3[${PYTHON_USEDEP}] )
    ...
    blink? ( ~dev-python/blinkpy-0.25.1[${PYTHON_USEDEP}] )
    ...
    google? ( ~dev-python/gcal-sync-8.0.0[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] ~dev-python/ical-12.1.1[${PYTHON_USEDEP}] )
    ...
    lcn? ( ~dev-python/pypck-0.9.7[${PYTHON_USEDEP}] ~dev-python/lcn-frontend-0.2.7[${PYTHON_USEDEP}] )
    ...
    local_calendar? ( ~dev-python/ical-12.1.1[${PYTHON_USEDEP}] )
    local_todo? ( ~dev-python/ical-12.1.1[${PYTHON_USEDEP}] )
    ...
    roborock? ( ~dev-python/python-roborock-3.12.2[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.4[${PYTHON_USEDEP}] )	
