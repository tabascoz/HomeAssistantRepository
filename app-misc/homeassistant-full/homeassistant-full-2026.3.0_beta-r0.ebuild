...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20260225.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	esphome? ( ~dev-python/aioesphomeapi-44.1.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.6.0[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/xknx-3.15.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.2[${PYTHON_USEDEP}] ~dev-python/knx-frontend-2026.2.25.165736[${PYTHON_USEDEP}] )
	...
	portainer? ( ~dev-python/pyportainer-1.0.27[${PYTHON_USEDEP}] )
	...
	smlight? ( ~dev-python/pysmlight-0.2.14[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/uiprotect-10.2.1[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/universal-silabs-flasher-0.1.2[${PYTHON_USEDEP}] ~dev-python/zha-1.0.0[${PYTHON_USEDEP}] ~dev-python/serialx-0.6.2[${PYTHON_USEDEP}] )
