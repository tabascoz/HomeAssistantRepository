...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20251203.0[${PYTHON_USEDEP}]
	...
	~dev-python/litellm-1.80.7[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
    ...
    amazon_devices? ( ~dev-python/aioamazondevices-10.0.0[${PYTHON_USEDEP}] ) 
    ...
    august? ( ~dev-python/yalexs-9.1.0[${PYTHON_USEDEP}] ~dev-python/yalexs-ble-3.2.1[${PYTHON_USEDEP}] )
    ...
    bluetooth? ( ~dev-python/bleak-2.0.0[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.4.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.1.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.4[${PYTHON_USEDEP}] ~dev-python/dbus-fast-3.1.2[${PYTHON_USEDEP}] ~dev-python/habluetooth-5.8.0[${PYTHON_USEDEP}] )
    ...
    home_connect? ( ~dev-python/aiohomeconnect-0.24.0[${PYTHON_USEDEP}] )
    ...
    knx? ( ~dev-python/xknx-3.12.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.2[${PYTHON_USEDEP}] ~dev-python/knx-frontend-2025.10.31.195356[${PYTHON_USEDEP}] )
    ...
    lamarzocco? ( ~dev-python/pylamarzocco-2.2.2[${PYTHON_USEDEP}] )
    ...
    media_extractor? ( ~net-misc/yt-dlp-2025.11.12 )
    ...
    renault? ( ~dev-python/renault-api-0.5.1[${PYTHON_USEDEP}] )
    renson? ( ~dev-python/renson-endura-delta-1.7.1[${PYTHON_USEDEP}] )
    reolink? ( ~dev-python/reolink-aio-0.17.0[${PYTHON_USEDEP}] )
    ...
    roborock? ( ~dev-python/python-roborock-3.9.3[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.4[${PYTHON_USEDEP}] )	
    ...
    smartthings? ( ~dev-python/pysmartthings-3.5.0[${PYTHON_USEDEP}] )
    ...
    smlight? ( ~dev-python/pysmlight-0.2.11[${PYTHON_USEDEP}] )
    ...
    tuya? ( ~dev-python/tuya-device-sharing-sdk-0.2.6[${PYTHON_USEDEP}] )
    ...
    unifiprotect? ( ~dev-python/uiprotect-7.31.0[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
    ...
    yale? ( ~dev-python/yalexs-9.0.1[${PYTHON_USEDEP}] ~dev-python/yalexs-ble-3.2.1[${PYTHON_USEDEP}] )
    yale_smart_alarm? ( ~dev-python/yalesmartalarmclient-0.4.3[${PYTHON_USEDEP}] )
    yalexs_ble? ( ~dev-python/yalexs-ble-3.2.1[${PYTHON_USEDEP}] )
    ...
    zha? ( ~dev-python/universal-silabs-flasher-0.1.2[${PYTHON_USEDEP}] ~dev-python/zha-0.0.80[${PYTHON_USEDEP}] )
...
## -- todo session 
##integrations to be added: - meteo.be, probeplus, iometer, citybikes, nintendoparental, victron_remote_monitoring, nordpool, airthings-ble,
# onewire (ownet), openrgb, actron_air, router_b_smart_meter, prowl, thethingsnetwork (ttn_client), sunricher dali , fing, inels,
# pooldose, openrouter, snawp, onedrive, backblase_b2, vegehub, watergate, ledpot, pyrefly_iii, saunum , lunatone, palazzetti, 
#actron air conditioners, hanna, uptime_kuma, saunum, fressnapf_tracker, letpot, google_air_quality, stiebel_eltron, energyid, hue_ble, anglian_water
# essent_dynamic_pricing, music_assistant, incomfort
