...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-intents-2026.2.13[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	lcn? ( ~dev-python/pypck-0.9.10[${PYTHON_USEDEP}] ~dev-python/lcn-frontend-0.2.7[${PYTHON_USEDEP}] )
	...
	rainbird? ( ~dev-python/pyrainbird-6.0.5[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartthings-3.5.3[${PYTHON_USEDEP}] )
