...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20250531.1[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	samsungtv? ( ~dev-python/getmac-0.9.4[${PYTHON_USEDEP}] ~dev-python/samsungctl-0.7.1[${PYTHON_USEDEP}] ~dev-python/samsungtvws-2.7.2[async,encrypted,${PYTHON_USEDEP}] ~dev-python/wakeonlan-2.1.0[${PYTHON_USEDEP}] ~dev-python/async-upnp-client-0.44.0[${PYTHON_USEDEP}] )
