...
RDEPEND="${RDEPEND}
	~dev-python/aiodhcpwatcher-1.2.0[${PYTHON_USEDEP}]
	...
	~dev-python/habluetooth-4.0.2[${PYTHON_USEDEP}]
	...
	~dev-python/home-assistant-frontend-20250806.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	bluetooth? ( ~dev-python/bleak-1.0.1[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.0.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.0.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.2[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.3[${PYTHON_USEDEP}] ~dev-python/habluetooth-4.0.2[${PYTHON_USEDEP}] ~dev-python/aiousbwatcher-1.1.1[${PYTHON_USEDEP}]   )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.111.1[${PYTHON_USEDEP}] )
	...
	esphome? ( ~dev-python/aioesphomeapi-37.2.2[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.1.0[${PYTHON_USEDEP}] )
	...
	inkbird? ( ~dev-python/inkbird-ble-0.16.2[${PYTHON_USEDEP}] )
	...
	matter? ( ~dev-python/python-matter-server-8.0.0[${PYTHON_USEDEP}] )
	...
	openai_conversation? ( ~dev-python/openai-1.68.2[${PYTHON_USEDEP}] )
