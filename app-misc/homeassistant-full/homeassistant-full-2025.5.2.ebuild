...
RDEPEND="${RDEPEND}
	...
	esphome? ( ~dev-python/aioesphomeapi-30.0.1[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-2.15.1[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartapp-0.3.5[${PYTHON_USEDEP}] ~dev-python/pysmartthings-3.2.2[${PYTHON_USEDEP}] dev-python/aiosseclient[${PYTHON_USEDEP}]  )
