...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20251105.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
    ...
    anthropic? ( ~dev-python/anthropic-0.69.0[${PYTHON_USEDEP}] )
    ...
    bluetooth? ( ~dev-python/bleak-1.1.1[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.4.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.1.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.4[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.45.0[${PYTHON_USEDEP}] ~dev-python/habluetooth-5.7.0[${PYTHON_USEDEP}] )
    ...
    dlna_dmr? ( ~dev-python/async-upnp-client-0.45.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.5[${PYTHON_USEDEP}] )
    dlna_dms? ( ~dev-python/async-upnp-client-0.45.0[${PYTHON_USEDEP}] )
    ...
    hardware? ( ~dev-python/psutil-home-assistant-0.0.1[${PYTHON_USEDEP}] ~dev-python/universal-silabs-flasher-0.1.0[${PYTHON_USEDEP}] ~dev-python/ha-silabs-firmware-client-0.2.0[${PYTHON_USEDEP}] )
    ...
    husqvarna_automower? ( ~dev-python/aioautomower-2.7.0[${PYTHON_USEDEP}] )
    ...
    icloud? ( ~dev-python/pyicloud-2.1.0[${PYTHON_USEDEP}] )
    ...
    inkbird? ( ~dev-python/inkbird-ble-1.1.0[${PYTHON_USEDEP}] )
    ...
    lamarzocco? ( ~dev-python/pylamarzocco-2.1.3[${PYTHON_USEDEP}] )
    ...
    lcn? ( ~dev-python/pypck-0.8.12[${PYTHON_USEDEP}] ~dev-python/lcn-frontend-0.2.7[${PYTHON_USEDEP}] )
    ...
    ohme? ( ~dev-python/ohme-1.5.2[${PYTHON_USEDEP}] )
    ...
    samsungtv? ( ~dev-python/getmac-0.9.5[${PYTHON_USEDEP}] ~dev-python/samsungctl-0.7.1[${PYTHON_USEDEP}] ~dev-python/samsungtvws-2.7.2[async,encrypted,${PYTHON_USEDEP}] ~dev-python/wakeonlan-3.1.0[${PYTHON_USEDEP}] ~dev-python/async-upnp-client-0.45.0[${PYTHON_USEDEP}] )
    ...
    shelly? ( ~dev-python/aioshelly-13.17.0[${PYTHON_USEDEP}] )
    ...
    smartthings? ( ~dev-python/pysmartthings-3.3.3[${PYTHON_USEDEP}] )
    ...
    sonos? ( ~dev-python/soco-0.30.12[${PYTHON_USEDEP}] ~dev-python/sonos-websocket-0.1.3[${PYTHON_USEDEP}] )
    ...
    ssdp? ( ~dev-python/async-upnp-client-0.45.0[${PYTHON_USEDEP}] )
    ...
    switchbot? ( ~dev-python/PySwitchbot-0.73.0[${PYTHON_USEDEP}] )
    ...
    unifi? ( ~dev-python/aiounifi-87[${PYTHON_USEDEP}] )
    unifi_direct? ( ~dev-python/unifi-ap-0.0.1[${PYTHON_USEDEP}] )
    unifiled? ( ~dev-python/unifiled-0.11[${PYTHON_USEDEP}] )
    unifiprotect? ( ~dev-python/uiprotect-7.23.0[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
    ...
    xbox? ( ~dev-python/python-xbox-0.1.1[${PYTHON_USEDEP}] )
    xbox_live? ( ~dev-python/python-xbox-0.1.1[${PYTHON_USEDEP}] )
    ...
    yeelight? ( ~dev-python/yeelight-0.7.14[${PYTHON_USEDEP}] ~dev-python/async-upnp-client-0.45.0[${PYTHON_USEDEP}] )
    ...
    zha? ( ~dev-python/universal-silabs-flasher-0.1.0[${PYTHON_USEDEP}] ~dev-python/zha-0.0.79[${PYTHON_USEDEP}] )
...
##integrations to be added: - meteo.be, probeplus, iometer, citybikes, nintendoparental, victron_remote_monitoring, nordpool, airthings-ble, onewire (ownet), openrgb, actron_air, router_b_smart_meter, prowl, thethingsnetwork (ttn_client), sunricher dali , fing, inels, pooldose, openrouter, snawp, onedrive, backblase_b2, vegehub, watergate, ledpot, pyrefly_iii, saunum , lunatone, palazzetti
