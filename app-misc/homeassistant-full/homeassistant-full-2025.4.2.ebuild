...
RDEPEND="${RDEPEND}
	...
	esphome? ( ~dev-python/aioesphomeapi-29.9.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.2.3[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-2.13.1[${PYTHON_USEDEP}] )
	...
	shelly? ( ~dev-python/aioshelly-13.4.1[${PYTHON_USEDEP}] )
	...
	xiaomi_ble? ( ~dev-python/xiaomi-ble-0.36.0[${PYTHON_USEDEP}] )
