...
RDEPEND="${RDEPEND}
	...
	compensation? ( ~dev-python/numpy-2.2.5[${PYTHON_USEDEP}] )
	...
	iqvia? ( ~dev-python/numpy-2.2.5[${PYTHON_USEDEP}] ~dev-python/pyiqvia-2022.4.0[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartapp-0.3.5[${PYTHON_USEDEP}] ~dev-python/pysmartthings-3.0.5[${PYTHON_USEDEP}] dev-python/aiosseclient[${PYTHON_USEDEP}]  )
	...
	stream? ( ~dev-python/PyTurboJPEG-1.7.5[${PYTHON_USEDEP}] ~dev-python/ha-av-10.1.1-r1[${PYTHON_USEDEP}] ~dev-python/numpy-2.2.5[${PYTHON_USEDEP}] )
	...
	trend? ( ~dev-python/numpy-2.2.5[${PYTHON_USEDEP}] )
