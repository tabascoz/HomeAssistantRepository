...
RDEPEND="${RDEPEND}
	...
	~dev-python/async-upnp-client-0.46.0[${PYTHON_USEDEP}]
	~dev-python/atomicwrites-homeassistant-1.4.1[${PYTHON_USEDEP}]
	dev-python/attrs[${PYTHON_USEDEP}]
	~dev-python/annotatedyaml-1.0.2[${PYTHON_USEDEP}]
	$(python_gen_cond_dep '~dev-python/audioop-lts-0.2.2[${PYTHON_USEDEP}]' python3_13)
	...
	~dev-python/go2rtc-client-0.3.0[${PYTHON_USEDEP}]
	...
	~dev-python/habluetooth-5.7.0[${PYTHON_USEDEP}]
	~dev-python/hass-nabucasa-1.5.1[${PYTHON_USEDEP}]
	~dev-python/hassil-3.3.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-bluetooth-2.0.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-frontend-20251105.1[${PYTHON_USEDEP}]
	~dev-python/home-assistant-intents-2025.11.7[${PYTHON_USEDEP}]
	...
	~dev-python/pymicro-vad-1.0.2[${PYTHON_USEDEP}]
	~dev-python/pynacl-1.5.0[${PYTHON_USEDEP}]
	dev-python/pyopenssl[${PYTHON_USEDEP}]
	~dev-python/pyserial-3.5[${PYTHON_USEDEP}]
	~dev-python/pyspeex-noise-1.0.2-r1[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
    ...
    accuweather? ( ~dev-python/accuweather-4.2.2[${PYTHON_USEDEP}] )
    acer_projector? ( ~dev-python/pyserial-3.5[${PYTHON_USEDEP}] )
    acmeda? ( ~dev-python/aiopulse-0.4.6[${PYTHON_USEDEP}] )
    adax? ( ~dev-python/adax-0.4.0[${PYTHON_USEDEP}] ~dev-python/Adax-local-0.2.0[${PYTHON_USEDEP}] )
    ...
    airos? ( ~dev-python/airos-0.6.0[${PYTHON_USEDEP}] )
    ...
    airzone? ( ~dev-python/aioairzone-1.0.2[${PYTHON_USEDEP}] )
    ...
    amazon_devices? ( ~dev-python/aioamazondevices-6.5.6[${PYTHON_USEDEP}] ) 
    ...
    androidtv? ( ~dev-python/adb-shell-0.4.4[async,${PYTHON_USEDEP}] ~dev-python/androidtv-0.0.75[async,${PYTHON_USEDEP}] ~dev-python/pure-python-adb-0.3.0-r2[async,${PYTHON_USEDEP}] )
    ...
    anthropic? ( ~dev-python/anthropic-0.73.0[${PYTHON_USEDEP}] )
    aosmith? ( ~dev-python/py-aosmith-1.0.15[${PYTHON_USEDEP}] )
    ...
    apple_tv? ( ~dev-python/pyatv-0.16.1[${PYTHON_USEDEP}] ~dev-python/tinytag-2.1.2[${PYTHON_USEDEP}]  )
    ...
    assist_pipeline? ( ~dev-python/pymicro-vad-1.0.1[${PYTHON_USEDEP}] ~dev-python/pyspeex-noise-1.0.2-r1[${PYTHON_USEDEP}] )
    asterisk_mbox? ( ~dev-python/asterisk_mbox-0.5.0[${PYTHON_USEDEP}] )
    asusrouter? ( ~dev-python/aiasusrouter-0.1.0[${PYTHON_USEDEP}] )
    asuswrt? ( ~dev-python/aioasuswrt-1.5.1[${PYTHON_USEDEP}] ~dev-python/pyasuswrt-0.1.21[${PYTHON_USEDEP}] )
    atag? ( ~dev-python/pyatag-0.3.5.3[${PYTHON_USEDEP}] )
    aten_pe? ( ~dev-python/atenpdu-0.3.2[${PYTHON_USEDEP}] )
    atome? ( ~dev-python/pyAtome-0.1.1[${PYTHON_USEDEP}] )
    august? ( ~dev-python/yalexs-9.1.0[${PYTHON_USEDEP}] ~dev-python/yalexs-ble-3.1.2[${PYTHON_USEDEP}] )
    ...
    axis? ( ~dev-python/axis-65[${PYTHON_USEDEP}] )
    ...
    backup? ( ~dev-python/securetar-2025.2.1[${PYTHON_USEDEP}] )
    ...
    bang_olufsen? ( ~dev-python/mozart-api-5.1.0.247.1[${PYTHON_USEDEP}] )
    ...
    bluetooth? ( ~dev-python/bleak-1.1.1[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.4.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.1.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.4[${PYTHON_USEDEP}] ~dev-python/dbus-fast-3.0.0[${PYTHON_USEDEP}] ~dev-python/habluetooth-5.7.0[${PYTHON_USEDEP}] )
    ...
    bosch_alarm? ( ~dev-python/bosch-alarm-mode2-0.4.6[${PYTHON_USEDEP}] )
    ...
    brother? ( ~dev-python/brother-5.1.1[${PYTHON_USEDEP}] )
    ...
    cloud? ( ~dev-python/hass-nabucasa-1.5.1[${PYTHON_USEDEP}] )
    ...
    comelit? ( ~dev-python/aiocomelit-1.1.2[${PYTHON_USEDEP}] )
    comfoconnect? ( ~dev-python/pycomfoconnect-0.5.1[${PYTHON_USEDEP}] )
    compensation? ( dev-python/numpy[${PYTHON_USEDEP}] )
    compit? ( ~dev-python/compit-inext-api-0.3.1[${PYTHON_USEDEP}] )
    ...
    daikin? ( ~dev-python/pydaikin-2.17.0[${PYTHON_USEDEP}] )
    ...
    debugpy? ( ~dev-python/debugpy-1.8.16[${PYTHON_USEDEP}] )
    ...
    denonavr? ( ~dev-python/denonavr-1.2.0[${PYTHON_USEDEP}] )
    ...
    dhcp? ( ~dev-python/aiodhcpwatcher-1.2.0[${PYTHON_USEDEP}] ~dev-python/aiodiscover-2.7.1[${PYTHON_USEDEP}] ~dev-python/cached-ipaddress-0.9.2[${PYTHON_USEDEP}] )
    ...
    dlna_dmr? ( ~dev-python/async-upnp-client-0.46.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.5[${PYTHON_USEDEP}] )
    dlna_dms? ( ~dev-python/async-upnp-client-0.46.0[${PYTHON_USEDEP}] )
    dnsip? ( ~dev-python/aiodns-3.5.0[${PYTHON_USEDEP}] )
    ...
    ecovacs? ( ~dev-python/py-sucks-0.9.11[${PYTHON_USEDEP}] ~dev-python/deebot-client-16.3.0[${PYTHON_USEDEP}] )
    ...
    eheimdigital? ( ~dev-python/eheimdigital-1.4.0[${PYTHON_USEDEP}] )
    ekeybionyx? ( ~dev-python/ekey-bionyxpy-1.0.0[${PYTHON_USEDEP}] )
    ...
    elkm1? ( ~dev-python/elkm1-lib-2.2.12[${PYTHON_USEDEP}] )
    ...
    enphase_envoy? ( ~dev-python/pyenphase-2.4.0[${PYTHON_USEDEP}] )
    entur_public_transport? ( ~dev-python/enturclient-0.2.4[${PYTHON_USEDEP}] )
    environment_canada? ( ~dev-python/env-canada-0.12.1[${PYTHON_USEDEP}] )
    ...
    eq3btsmart? ( ~dev-python/eq3btsmart-2.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.4.0[${PYTHON_USEDEP}] )
    escea? ( ~dev-python/pescea-1.0.12[${PYTHON_USEDEP}] )
    esphome? ( ~dev-python/aioesphomeapi-42.7.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.4.0[${PYTHON_USEDEP}] )
    ...
    firefly_iii? ( ~dev-python/pyfirefly-0.1.6[${PYTHON_USEDEP}] )
    ...
    forecast_solar? ( ~dev-python/forecast-solar-4.2.0[${PYTHON_USEDEP}] )
    ...
    fritz? ( ~dev-python/fritzconnection-1.15.0[qrcode,${PYTHON_USEDEP}] ~dev-python/xmltodict-0.14.2[${PYTHON_USEDEP}] )
    ...
    generic? ( ~dev-python/av-13.1.0[${PYTHON_USEDEP}] dev-python/pillow[${PYTHON_USEDEP}] )
    ...
    google? ( ~dev-python/gcal-sync-8.0.0[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] ~dev-python/ical-11.1.0[${PYTHON_USEDEP}] )
    ...
    google_generative_ai_conversation? ( dev-python/google-genai[${PYTHON_USEDEP}]  )
    ...
    govee_light_local? ( ~dev-python/govee-local-api-2.2.0[${PYTHON_USEDEP}] )
    ...
    growatt_server? ( ~dev-python/growattServer-1.7.1[${PYTHON_USEDEP}] )
    ...
    hardware? ( ~dev-python/psutil-home-assistant-0.0.1[${PYTHON_USEDEP}] ~dev-python/universal-silabs-flasher-0.1.2[${PYTHON_USEDEP}] ~dev-python/ha-silabs-firmware-client-0.2.0[${PYTHON_USEDEP}] )
    ...
    hive? ( ~dev-python/pyhive-integration-1.0.6[${PYTHON_USEDEP}] )
    ...
    home_connect? ( ~dev-python/aiohomeconnect-0.23.1[${PYTHON_USEDEP}] )
    ...
    homematicip_cloud? ( ~dev-python/homematicip-2.4.0[${PYTHON_USEDEP}] )
    homewizard? ( ~dev-python/python-homewizard-energy-9.3.0[${PYTHON_USEDEP}] )
    ...
    husqvarna_automower? ( ~dev-python/aioautomower-2.7.1[${PYTHON_USEDEP}] )
    ...
    icloud? ( ~dev-python/pyicloud-2.2.0[${PYTHON_USEDEP}] )
    ...
    imgw_pib? ( ~dev-python/imgw-pib-1.5.6[${PYTHON_USEDEP}] )
    immich? ( ~dev-python/aioimmich-0.11.1[${PYTHON_USEDEP}] )
    improv_ble? ( ~dev-python/py-improv-ble-client-1.0.3[${PYTHON_USEDEP}] )
    incomfort? ( ~dev-python/incomfort-client-0.6.3[${PYTHON_USEDEP}] )
    influxdb? ( ~dev-python/influxdb-5.3.2[${PYTHON_USEDEP}] ~dev-python/influxdb-client-1.48.0[${PYTHON_USEDEP}] )
    ...
    intellifire? ( ~dev-python/intellifire4py-4.2.1[${PYTHON_USEDEP}] )
    ...
    knx? ( ~dev-python/xknx-3.10.1[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.2[${PYTHON_USEDEP}] ~dev-python/knx-frontend-2025.10.31.195356[${PYTHON_USEDEP}] )
    ...
    lamarzocco? ( ~dev-python/pylamarzocco-2.2.0[${PYTHON_USEDEP}] )
    ...
    lcn? ( ~dev-python/pypck-0.9.4[${PYTHON_USEDEP}] ~dev-python/lcn-frontend-0.2.7[${PYTHON_USEDEP}] )
    ...
    lg_thinq? ( ~dev-python/thinqconnect-1.0.8[${PYTHON_USEDEP}] )
    libre_hardware_monitor? ( ~dev-python/librehardwaremonitor-api-1.5.0[${PYTHON_USEDEP}] )
    ...
    litterrobot? ( ~dev-python/pylitterbot-2025.0.0[${PYTHON_USEDEP}] )
    livisi? ( ~dev-python/aiolivisi-0.0.19[${PYTHON_USEDEP}] )
    local_calendar? ( ~dev-python/ical-11.1.0[${PYTHON_USEDEP}] )
    local_todo? ( ~dev-python/ical-11.1.0[${PYTHON_USEDEP}] )
    ...
    matter? ( ~dev-python/python-matter-server-8.1.0[${PYTHON_USEDEP}] )
    ...
    miele? ( ~dev-python/pymiele-0.6.0[${PYTHON_USEDEP}] )
    mikrotik? ( ~dev-python/librouteros-3.2.0[${PYTHON_USEDEP}] )
    mill? ( ~dev-python/millheater-0.14.1[${PYTHON_USEDEP}] )
    minecraft_server? ( ~dev-python/mcstatus-12.0.6[${PYTHON_USEDEP}] )
    ...
    nest? ( ~dev-python/google-nest-sdm-9.0.1[${PYTHON_USEDEP}] )
    ...
    nibe_heatpump? ( ~dev-python/nibe-2.19.0[${PYTHON_USEDEP}] )
    ...
    ntfy? ( ~dev-python/aiontfy-0.6.1[${PYTHON_USEDEP}] )
    ...
    openai_conversation? ( ~dev-python/openai-2.8.0[${PYTHON_USEDEP}] )
    ...
    opower? ( ~dev-python/opower-0.15.9[${PYTHON_USEDEP}] )
    ...
    qingping? ( ~dev-python/qingping-ble-1.0.1[${PYTHON_USEDEP}] )
    ...
    renault? ( ~dev-python/renault-api-0.5.0[${PYTHON_USEDEP}] )
    renson? ( ~dev-python/renson-endura-delta-1.7.1[${PYTHON_USEDEP}] )
    reolink? ( ~dev-python/reolink-aio-0.16.5[${PYTHON_USEDEP}] )
    repetier? ( ~dev-python/pyrepetierng-0.1.0[${PYTHON_USEDEP}] )
    rest? ( ~dev-python/jsonpath-0.82.2[${PYTHON_USEDEP}] ~dev-python/xmltodict-0.14.2[${PYTHON_USEDEP}] )
    ...
    roborock? ( ~dev-python/python-roborock-3.7.1[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.4[${PYTHON_USEDEP}] )	
    ...
    route_b_smartmeter? ( ~dev-python/pyserial-3.5[${PYTHON_USEDEP}] )
    ...
    ruuvitag_ble? ( ~dev-python/ruuvitag-ble-0.3.0[${PYTHON_USEDEP}] )
    ...
    samsungtv? ( ~dev-python/getmac-0.9.5[${PYTHON_USEDEP}] ~dev-python/samsungctl-0.7.1[${PYTHON_USEDEP}] ~dev-python/samsungtvws-2.7.2[async,encrypted,${PYTHON_USEDEP}] ~dev-python/wakeonlan-3.1.0[${PYTHON_USEDEP}] ~dev-python/async-upnp-client-0.46.0[${PYTHON_USEDEP}] )
    ...
    sharkiq? ( ~dev-python/sharkiq-1.4.2[${PYTHON_USEDEP}] )
    shelly? ( ~dev-python/aioshelly-13.20.0[${PYTHON_USEDEP}] )
    ...
    sma? ( ~dev-python/pysma-1.0.2[${PYTHON_USEDEP}] )
    ...
    smartthings? ( ~dev-python/pysmartthings-3.3.4[${PYTHON_USEDEP}] )
    smarttub? ( ~dev-python/python-smarttub-0.0.45[${PYTHON_USEDEP}] )
    ...
    snmp? ( ~dev-python/pysnmp-7.1.21[${PYTHON_USEDEP}] )
    ...
    solarlog? ( ~dev-python/solarlog-cli-0.6.0[${PYTHON_USEDEP}] )
    ...
    sonos? ( ~dev-python/soco-0.30.12[${PYTHON_USEDEP}] ~dev-python/sonos-websocket-0.1.3[${PYTHON_USEDEP}] ~dev-python/defusedxml-0.7.1[${PYTHON_USEDEP}]  )
    ...
    speedtestdotnet? ( ~net-analyzer/speedtest-cli-2.1.3-r2[${PYTHON_USEDEP}] )
    ...
    ssdp? ( ~dev-python/async-upnp-client-0.46.0[${PYTHON_USEDEP}] )
    ...
    startca? ( ~dev-python/xmltodict-0.14.2[${PYTHON_USEDEP}] )
    ...
    stream? ( ~dev-python/PyTurboJPEG-1.8.0[${PYTHON_USEDEP}] ~dev-python/av-13.1.0[${PYTHON_USEDEP}] dev-python/numpy[${PYTHON_USEDEP}] )
    ...
    switchbot? ( ~dev-python/PySwitchbot-0.74.0[${PYTHON_USEDEP}] )
    ...
    system_bridge? ( ~dev-python/systembridgeconnector-5.1.0[${PYTHON_USEDEP}] ~dev-python/systembridgemodels-4.2.4[${PYTHON_USEDEP}] )
    ...
    ted5000? ( ~dev-python/xmltodict-0.14.2[${PYTHON_USEDEP}] )
    ...
    tesla_fleet? ( ~dev-python/tesla-fleet-api-1.2.5[${PYTHON_USEDEP}] )
    tesla_wall_connector? ( ~dev-python/tesla-wall-connector-1.1.0[${PYTHON_USEDEP}] )
    teslemetry? ( ~dev-python/tesla-fleet-api-1.2.5[${PYTHON_USEDEP}] )
    tessie? ( ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-1.2.5[${PYTHON_USEDEP}] )
    tfiac? ( ~dev-python/pytfiac-0.4[${PYTHON_USEDEP}] )
    thermobeacon? ( ~dev-python/thermobeacon-ble-0.7.0[${PYTHON_USEDEP}] )
    thermopro? ( ~dev-python/thermopro-ble-1.1.2[${PYTHON_USEDEP}] )
    ...
    thread? ( ~dev-python/python-otbr-api-2.6.0[${PYTHON_USEDEP}] ~dev-python/pyroute2-0.7.12-r1[${PYTHON_USEDEP}] )
    tibber? ( ~dev-python/pyTibber-0.32.2[${PYTHON_USEDEP}] )
    ...
    touchline_sl? ( ~dev-python/pytouchlinesl-0.5.0[${PYTHON_USEDEP}] )
    ...
    tuya? ( ~dev-python/tuya-device-sharing-sdk-0.2.4[${PYTHON_USEDEP}] )
    ...
    unifiprotect? ( ~dev-python/uiprotect-7.26.0[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
    ...
    upnp? ( ~dev-python/async-upnp-client-0.46.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.5[${PYTHON_USEDEP}] )
    ...
    velbus? ( ~dev-python/velbus-aio-2025.11.0[${PYTHON_USEDEP}] )
    ...
    vesync? ( ~dev-python/pyvesync-3.2.2[${PYTHON_USEDEP}] )
    vicare? ( ~dev-python/PyViCare-2.55.0[${PYTHON_USEDEP}] )
    victron_ble? ( ~dev-python/victron-ble-ha-parser-0.4.9[${PYTHON_USEDEP}] )
    ...
    vodafone_station? ( ~dev-python/aiovodafone-3.0.0[${PYTHON_USEDEP}] )
    ...
    waterfurnace? ( ~dev-python/waterfurnace-1.2.0[${PYTHON_USEDEP}] )
    ...
    webdav? ( ~dev-python/aiowebdav2-0.4.6[${PYTHON_USEDEP}] )
    ...
    whirlpool? ( ~dev-python/whirlpool-sixth-sense-1.0.2[${PYTHON_USEDEP}] )
    ...
    xbox? ( ~dev-python/python-xbox-0.1.2[${PYTHON_USEDEP}] )
    xbox_live? ( ~dev-python/python-xbox-0.1.2[${PYTHON_USEDEP}] )
    xeoma? ( ~dev-python/pyxeoma-1.4.1[${PYTHON_USEDEP}] )
    xiaomi_aqara? ( ~dev-python/PyXiaomiGateway-0.14.3[${PYTHON_USEDEP}] )
    xiaomi_ble? ( ~dev-python/xiaomi-ble-1.2.0[${PYTHON_USEDEP}] )
    ...
    xmpp? ( ~dev-python/slixmpp-1.12.0[${PYTHON_USEDEP}] ~dev-python/emoji-2.8.0[${PYTHON_USEDEP}] )
    xs1? ( ~dev-python/xs1-api-client-3.0.0[${PYTHON_USEDEP}] )
    yale? ( ~dev-python/yalexs-9.0.1[${PYTHON_USEDEP}] ~dev-python/yalexs-ble-3.1.2[${PYTHON_USEDEP}] )
    yale_smart_alarm? ( ~dev-python/yalesmartalarmclient-0.4.3[${PYTHON_USEDEP}] )
    yalexs_ble? ( ~dev-python/yalexs-ble-3.1.2[${PYTHON_USEDEP}] )
    ...
    yeelight? ( ~dev-python/yeelight-0.7.14[${PYTHON_USEDEP}] ~dev-python/async-upnp-client-0.46.0[${PYTHON_USEDEP}] )
    ...
    youtube? ( ~dev-python/youtubeaio-2.1.0[${PYTHON_USEDEP}] )
    ...
    zestimate? ( ~dev-python/xmltodict-0.14.2[${PYTHON_USEDEP}] )
    zeversolar? ( ~dev-python/zeversolar-0.3.1[${PYTHON_USEDEP}] )
    zha? ( ~dev-python/universal-silabs-flasher-0.1.2[${PYTHON_USEDEP}] ~dev-python/zha-0.0.79[${PYTHON_USEDEP}] )
    ...
    zwave_js? ( ~dev-python/pyserial-3.5[${PYTHON_USEDEP}] ~dev-python/zwave-js-server-python-0.67.1[${PYTHON_USEDEP}] )
    zwave_me? ( ~dev-python/zwave-me-ws-0.4.3[${PYTHON_USEDEP}] ~dev-python/url-normalize-1.4.3[${PYTHON_USEDEP}] )"
## -- todo session 
##integrations to be added: - meteo.be, probeplus, iometer, citybikes, nintendoparental, victron_remote_monitoring, nordpool, airthings-ble, onewire (ownet), openrgb, actron_air, router_b_smart_meter, prowl, thethingsnetwork (ttn_client), sunricher dali , fing, inels, pooldose, openrouter, snawp, onedrive, backblase_b2, vegehub, watergate, ledpot, pyrefly_iii, saunum , lunatone, palazzetti, actron air conditioners, hanna, uptime_kuma, saunum
# review before august 25 2025
BDEPEND="${RDEPEND}
	test? (
