...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20250401.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	inkbird? ( ~dev-python/inkbird-ble-0.9.0[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartapp-0.3.5[${PYTHON_USEDEP}] ~dev-python/pysmartthings-3.0.1[${PYTHON_USEDEP}] dev-python/aiosseclient[${PYTHON_USEDEP}]  )
