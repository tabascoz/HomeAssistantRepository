...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-intents-2025.10.28[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
    ...
    iron_os? ( ~dev-python/pynecil-4.2.0[${PYTHON_USEDEP}] )
    ...
    zha? ( ~dev-python/universal-silabs-flasher-0.0.37[${PYTHON_USEDEP}] ~dev-python/zha-0.0.77[${PYTHON_USEDEP}] )
