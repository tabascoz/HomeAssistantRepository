...
RDEPEND="${RDEPEND}
	...
	~dev-python/bluetooth-auto-recovery-1.5.2[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	august? ( ~dev-python/yalexs-9.0.1[${PYTHON_USEDEP}] ~dev-python/yalexs-ble-3.1.2[${PYTHON_USEDEP}] )
	...
	bluetooth? ( ~dev-python/bleak-1.1.0[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.4.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.1.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.2[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.3[${PYTHON_USEDEP}] ~dev-python/habluetooth-5.6.4[${PYTHON_USEDEP}] ~dev-python/aiousbwatcher-1.1.1[${PYTHON_USEDEP}]   )
	...
	eq3btsmart? ( ~dev-python/eq3btsmart-1.1.9[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.2.0[${PYTHON_USEDEP}] )
	escea? ( ~dev-python/pescea-1.0.12[${PYTHON_USEDEP}] )
	esphome? ( ~dev-python/aioesphomeapi-40.1.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.2.0[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/holidays-0.79[${PYTHON_USEDEP}] ~dev-python/Babel-2.15.0[${PYTHON_USEDEP}] )
	...
	lcn? ( ~dev-python/pypck-0.7.23[${PYTHON_USEDEP}] ~dev-python/lcn-frontend-0.1.6[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.15.4[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.15.0[${PYTHON_USEDEP}] )
	...
	shelly? ( ~dev-python/aioshelly-13.9.0[${PYTHON_USEDEP}] )
	...
	switchbot? ( ~dev-python/PySwitchbot-0.70.0[${PYTHON_USEDEP}] )
	...
	workday? ( ~dev-python/holidays-0.79[${PYTHON_USEDEP}] )
...
##tb added - Droplet,(ai)ntfy,(py)Homee, ohme(py), asusrouter(asuswrt), volvocars, ubiquity airos, brother, aladdin connect, aioamazondevices
## thchanged habitica(lib), zabbix
