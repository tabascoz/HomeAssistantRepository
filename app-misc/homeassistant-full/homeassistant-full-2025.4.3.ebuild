...
RDEPEND="${RDEPEND}
	...
	~dev-python/bluetooth-data-tools-1.27.0[${PYTHON_USEDEP}]
	...
	~dev-python/habluetooth-3.39.0[${PYTHON_USEDEP}]
	~dev-python/hass-nabucasa-0.95.0[${PYTHON_USEDEP}]
	~dev-python/hassil-2.2.3[${PYTHON_USEDEP}]
	~dev-python/home-assistant-bluetooth-1.13.1[${PYTHON_USEDEP}]
	~dev-python/home-assistant-frontend-20250411.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-intents-2025.3.23[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	androidtv_remote? ( ~dev-python/androidtvremote2-0.2.1[${PYTHON_USEDEP}] )
	...
	bluetooth? ( ~dev-python/bleak-0.22.3[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-3.10.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.4.5[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.27.0[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.1[${PYTHON_USEDEP}] ~dev-python/habluetooth-3.39.0[${PYTHON_USEDEP}] )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.95.0[${PYTHON_USEDEP}] )
	...
	compensation? ( ~dev-python/numpy-2.2.3[${PYTHON_USEDEP}] )
	...
	dhcp? ( ~dev-python/aiodhcpwatcher-1.0.2[${PYTHON_USEDEP}] ~dev-python/aiodiscover-2.6.1[${PYTHON_USEDEP}] ~dev-python/cached-ipaddress-0.9.2[${PYTHON_USEDEP}] )
	...
	eq3btsmart? ( ~dev-python/eq3btsmart-1.1.9[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-2.13.1[${PYTHON_USEDEP}] )
	escea? ( ~dev-python/pescea-1.0.12[${PYTHON_USEDEP}] )
	esphome? ( ~dev-python/aioesphomeapi-30.0.1[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-2.13.1[${PYTHON_USEDEP}] )
	...
	forecast_solar? ( ~dev-python/forecast-solar-4.1.0[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-6.1.6[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] ~dev-python/ical-9.0.1[${PYTHON_USEDEP}] )
	...
	home_connect? ( ~dev-python/homeconnect-0.8.0[${PYTHON_USEDEP}] ~dev-python/aiohomeconnect-0.16.3[${PYTHON_USEDEP}] dev-python/httpx-sse[${PYTHON_USEDEP}]  )
	...
	inkbird? ( ~dev-python/inkbird-ble-0.11.0[${PYTHON_USEDEP}] )
	...
	iqvia? ( ~dev-python/numpy-2.2.3[${PYTHON_USEDEP}] ~dev-python/pyiqvia-2022.4.0[${PYTHON_USEDEP}] )
	...
	ld2410_ble? ( ~dev-python/bluetooth-data-tools-1.27.0[${PYTHON_USEDEP}] ~dev-python/ld2410-ble-0.1.1[${PYTHON_USEDEP}] )
	leaone? ( ~dev-python/leaone-ble-0.1.0[${PYTHON_USEDEP}] )
	led_ble? ( ~dev-python/bluetooth-data-tools-1.27.0[${PYTHON_USEDEP}] ~dev-python/led-ble-1.0.2[${PYTHON_USEDEP}] )
	...
	private_ble_device? ( ~dev-python/bluetooth-data-tools-1.27.0[${PYTHON_USEDEP}] )
	...
	scrape? ( ~dev-python/beautifulsoup4-4.12.3[${PYTHON_USEDEP}] ~dev-python/lxml-5.3.2[${PYTHON_USEDEP}] )
	...
	shelly? ( ~dev-python/aioshelly-13.5.0[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartapp-0.3.5[${PYTHON_USEDEP}] ~dev-python/pysmartthings-3.0.4[${PYTHON_USEDEP}] dev-python/aiosseclient[${PYTHON_USEDEP}]  )
	...
	stream? ( ~dev-python/PyTurboJPEG-1.7.5[${PYTHON_USEDEP}] ~dev-python/ha-av-10.1.1-r1[${PYTHON_USEDEP}] ~dev-python/numpy-2.2.3[${PYTHON_USEDEP}] )
	...
	tesla_fleet? ( ~dev-python/tesla-fleet-api-1.0.17[${PYTHON_USEDEP}] )
	tesla_wall_connector? ( ~dev-python/tesla-wall-connector-1.0.2[${PYTHON_USEDEP}] )
	teslemetry? ( ~dev-python/tesla-fleet-api-1.0.17[${PYTHON_USEDEP}] )
	tessie? ( ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-1.0.17[${PYTHON_USEDEP}] )
	...
	trend? ( ~dev-python/numpy-2.2.3[${PYTHON_USEDEP}] )
	...
	xiaomi_ble? ( ~dev-python/xiaomi-ble-0.37.0[${PYTHON_USEDEP}] )
