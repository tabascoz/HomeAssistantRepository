...
RDEPEND="${RDEPEND}
    ...
    amazon_devices? ( ~dev-python/aioamazondevices-6.4.6[${PYTHON_USEDEP}] ) 
    ...
    cync? ( ~dev-python/pycync-0.4.2[${PYTHON_USEDEP}] )
    ...
    ecovacs? ( ~dev-python/py-sucks-0.9.11[${PYTHON_USEDEP}] ~dev-python/deebot-client-16.1.0[${PYTHON_USEDEP}] )
    ...
    esphome? ( ~dev-python/aioesphomeapi-42.1.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.3.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-3.4.0[${PYTHON_USEDEP}] )
    ...
    holiday? ( ~dev-python/holidays-0.83[${PYTHON_USEDEP}] ~dev-python/Babel-2.15.0[${PYTHON_USEDEP}] )
    ...
    husqvarna_automower? ( ~dev-python/aioautomower-2.6.0[${PYTHON_USEDEP}] )
    ...
    knx? ( ~dev-python/xknx-3.10.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.2[${PYTHON_USEDEP}] ~dev-python/knx-frontend-2025.10.26.81530[${PYTHON_USEDEP}] )
    ...
    litterrobot? ( ~dev-python/pylitterbot-2024.2.7[${PYTHON_USEDEP}] )
    ...
    opower? ( ~dev-python/opower-0.15.8[${PYTHON_USEDEP}] )
    ...
    roborock? ( ~dev-python/python-roborock-3.3.3[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.4[${PYTHON_USEDEP}] )	
    ...
    shelly? ( ~dev-python/aioshelly-13.15.0[${PYTHON_USEDEP}] )
    ...
    switchbot? ( ~dev-python/PySwitchbot-0.72.0[${PYTHON_USEDEP}] )
    ...
    workday? ( ~dev-python/holidays-0.83[${PYTHON_USEDEP}] )
...
##integrations to be added: - meteo.be, probeplus, iometer, citybikes, nintendoparental, victron_remote_monitoring, nordpool, airthings-ble, onewire (ownet), openrgb, actron_air, router_b_smart_meter, prowl, thethingsnetwork (ttn_client), dali center , fing, inels
