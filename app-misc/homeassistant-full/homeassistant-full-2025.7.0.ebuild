...
RDEPEND="${RDEPEND}
	...
	~dev-python/hass-nabucasa-0.104.0[${PYTHON_USEDEP}]
	~dev-python/hassil-2.2.3[${PYTHON_USEDEP}]
	~dev-python/home-assistant-bluetooth-1.13.1[${PYTHON_USEDEP}]
	~dev-python/home-assistant-frontend-20250702.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	bluetooth? ( ~dev-python/bleak-0.22.3[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.0.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.2[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.1[${PYTHON_USEDEP}] ~dev-python/habluetooth-3.49.0[${PYTHON_USEDEP}] ~dev-python/aiousbwatcher-1.1.1[${PYTHON_USEDEP}]   )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.104.0[${PYTHON_USEDEP}] )
	...
	shelly? ( ~dev-python/aioshelly-13.7.1[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartapp-0.3.5[${PYTHON_USEDEP}] ~dev-python/pysmartthings-3.2.5[${PYTHON_USEDEP}] dev-python/aiosseclient[${PYTHON_USEDEP}]  )
